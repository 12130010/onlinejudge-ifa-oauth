...
.and()
		.withClient(env.getProperty("onlinejudge.ms.contest.id"))
		.secret(env.getProperty("onlinejudge.ms.contest.password"))
		.authorizedGrantTypes("client_credentials", "refresh_token", "authorization_code")
		.scopes("server")
		.accessTokenValiditySeconds(0)
.and()
		.withClient(env.getProperty("onlinejudge.ms.resource.id"))
		.secret(env.getProperty("onlinejudge.ms.resource.password"))
		.authorizedGrantTypes("client_credentials", "refresh_token", "authorization_code")
		.scopes("server")
		.accessTokenValiditySeconds(0)
.and()
		.withClient(env.getProperty("onlinejudge.ms.judge.id"))
		.secret(env.getProperty("onlinejudge.ms.judge.password"))
		.authorizedGrantTypes("client_credentials", "refresh_token", "authorization_code")
		.scopes("server")
		.accessTokenValiditySeconds(0)
//.and()
